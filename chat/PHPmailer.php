    ...
    if(filter_var($email, FILTER_VALIDATE_EMAIL)){
        ...
        if($count == 1){
            ...
            if(mysqli_query($connect, $sql2)) {
                ...
                IsSMTP();
                $mail->Host = "server191.web-hosting.com";  // specify main and backup server
                $mail->SMTPAuth = true;     // turn on SMTP authentication
                $mail->Username = "no-reply@omadahq.com";  // SMTP username
                $mail->Password = "hED3[3syLm5~5{J"; // SMTP password
                ...
                $mail->From = "no-reply@omadahq.com";
                $mail->FromName = "OmadaHQ";
